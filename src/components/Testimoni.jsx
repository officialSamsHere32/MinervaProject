    ...
    <>
        <section className="w-full flex sm:h-[720px] 2xl:h-[840px] bg-[#007bff] justify-center flex-col items-center py-24 px-4">
            <div className="flex-row">
                <h1 className="sm:w-[467px] sm:h-[55px] xl:h-[70px] text-5xl text-center mx-auto mb-3 font-bold text-white">Testimoni</h1>
                <div className="sm:w-[800px] sm:h-[300px] bg-white rounded-2xl shadow-xl flex transition duration-300 mb-9 text-center">
