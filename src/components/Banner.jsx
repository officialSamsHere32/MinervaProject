  ...
  return (
    <>
      <section className="w-full flex justify-center py-24 px-4">
        <div className="sm:w-[990px] sm:flex flex-col bg-white rounded-2xl shadow-lg py-8 px-8 sm:px-12 transition duration-300 mb-9 text-center">
          ...
          <div className="mt-8 w-full flex sm:flex-col items-center gap-4">
            ...
            <button className="mt-2 w-full max-w-xs sm:h-[50px] h-[100%] rounded-xl bg-[#007bff] sm:px-6 sm:py-3 py-[143px] text-base font-semibold text-white shadow-md hover:bg-[#0056d6] transition duration-200">
              Gabung
            </button>
          </div>
        </div>
